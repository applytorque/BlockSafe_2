                        ...
                        >
                              <div className="wrapper" data-v-f0c16b6f="">
                                    ...
                                    <div className="subtitle" data-v-f0c16b6f="">
                                         <b className='text-yellow-300'>De-centralization-as-a-Service(DAAS) Business Model :</b> <br />
                                         DaaS functions like a sort of web host, running the back-end operation for a block-chain based app or platform (MV Dapps)
                                    </div>
                              </div>
                              <div className="items-container wrapper" data-v-f0c16b6f="">
                                    ...
                                    >
                                          ...
                                          <div className="subtitle" data-v-6ee8dd1e="">
                                                Non-adjustable minimum number of confirmations for transactions
                                          </div>
                                    ...
                                    >
                                          <div className="title-with-icon" data-v-6ee8dd1e="">
                                                <div className="title text-gray-400" data-v-6ee8dd1e="">
                                                      Wallet Addition / Removal
                                                </div>

                                          </div>
                                          <div className="subtitle" data-v-6ee8dd1e="">
                                                Through On-chain voting by members.
                                          </div>
                                    ...
                                    >
                                          ...
                                          <div className="subtitle" data-v-6ee8dd1e="">
                                                DAO Propulsion cell, BD Team, Asset Management consulting, collaboration with Popular IDO/IEO launchpads
                                          </div>
                        ...
                        >
                              ...
                              <div className=" mx-auto mt-10" data-v-abed6bf0="">
                                    <div className=" block md:flex gap-20 mx-auto w-[80%]" data-v-abed6bf0="">
                                          ...
                                          <div
                                                className=" text-white
                                                      py-5 px-8 rounded-lg hover:from-blue-600
                                                     w-80 my-6 md:my-0 text-lg bg-gray-60 border border-gray-700 "
                                                data-v-abed6bf0=""
                                                data-v-d855b919=""
                                          >
                                                <div className="label" data-v-d855b919="">
