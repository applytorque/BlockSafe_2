                        ...
                        <div className='md:flex md:justify-between ' >
                            <div className='relative z-100'>
                                <h1 className="title" data-v-864e500f="">
                                    Decentralized  <span data-v-864e500f="">Crypto</span>
                                ...
                                {/* <div className="button-compose flex" data-v-864e500f="">
                                    <a href="/buy" className="" data-v-864e500f="">
                                        <button
                                            className="bg-gradient-to-r from-blue-800 via-purple-600 to-blue-400 text-white py-4 px-6 rounded-lg mt-1 hover:from-blue-600
                            ...
                            <div className='absolute   md:relative'>
                                <img
                                    ...
                                    className="md:h-[420px] md:w-[420px] mt-10 md:mt-0 shadow-2xl  rounded-full "
                                    data-v-864e500f=""
                                />
                            </div>
                        </div>
